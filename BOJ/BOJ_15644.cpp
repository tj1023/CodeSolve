...
pair<int, string> bfs(point hole, point red, point blue, vector<vector<char>> board) {
	queue<node> rq;
	queue<point> bq;
	...
	while (!rq.empty() && !bq.empty()) {
		...
		if (curr.y < curb.first) {
			...
			if (redGoal && canMove) return { curr.depth + 1, curr.dir + 'U' };
		}
		else {
			while (nextb.first - 1 >= 0 && board[nextb.first - 1][nextb.second] != '#') {
				nextb.first--;
			...
			if (canMove) {
				while (nextr.first - 1 >= 0 && board[nextr.first - 1][nextr.second] != '#' &&
					...
					nextr.first--;
					if (board[nextr.first][nextr.second] == 'O') return { curr.depth + 1, curr.dir + 'U' };
				}
			}
		}
		if (canMove && !visited[nextr.first][nextr.second][nextb.first][nextb.second]) {
			rq.push({ nextr.first, nextr.second, curr.depth + 1, curr.dir + 'U' });
			bq.push(nextb);
		...
		if (curr.y > curb.first) {
			...
			if (redGoal && canMove) return { curr.depth + 1, curr.dir + 'D' };
		}
		else {
			while (nextb.first + 1 < n && board[nextb.first + 1][nextb.second] != '#') {
				nextb.first++;
			...
			if (canMove) {
				while (nextr.first + 1 < n && board[nextr.first + 1][nextr.second] != '#' &&
					!(nextr.first + 1 == nextb.first && nextr.second == nextb.second)) {
					nextr.first++;
					if (board[nextr.first][nextr.second] == 'O') return { curr.depth + 1, curr.dir + 'D' };
				}
			}
		}
		if (canMove && !visited[nextr.first][nextr.second][nextb.first][nextb.second]) {
			rq.push({ nextr.first, nextr.second, curr.depth + 1, curr.dir + 'D' });
			bq.push(nextb);
			visited[nextr.first][nextr.second][nextb.first][nextb.second] = true;
		}
		...
		if (curr.x < curb.second) {
			...
			if (redGoal && canMove) return { curr.depth + 1, curr.dir + 'L' };
		}
		else {
			while (nextb.second - 1 >= 0 && board[nextb.first][nextb.second - 1] != '#') {
				nextb.second--;
			...
			if (canMove) {
				while (nextr.second - 1 >= 0 && board[nextr.first][nextr.second - 1] != '#' &&
					...
					nextr.second--;
					if (board[nextr.first][nextr.second] == 'O') return { curr.depth + 1, curr.dir + 'L' };
				}
			}
		}
		if (canMove && !visited[nextr.first][nextr.second][nextb.first][nextb.second]) {
			rq.push({ nextr.first, nextr.second, curr.depth + 1, curr.dir + 'L' });
			bq.push(nextb);
			visited[nextr.first][nextr.second][nextb.first][nextb.second] = true;
		}
		...
		if (curr.x > curb.second) {
			...
			if (redGoal && canMove) return { curr.depth + 1, curr.dir + 'R' };
		}
		else {
			while (nextb.second + 1 < m && board[nextb.first][nextb.second + 1] != '#') {
				nextb.second++;
			...
			if (canMove) {
				while (nextr.second + 1 < m && board[nextr.first][nextr.second + 1] != '#' &&
					!(nextr.first == nextb.first && nextr.second + 1 == nextb.second)) {
					nextr.second++;
					if (board[nextr.first][nextr.second] == 'O') return { curr.depth + 1, curr.dir + 'R' };
				}
			}
		}
		if (canMove && !visited[nextr.first][nextr.second][nextb.first][nextb.second]) {
			rq.push({ nextr.first, nextr.second, curr.depth + 1, curr.dir + 'R' });
			bq.push(nextb);
			visited[nextr.first][nextr.second][nextb.first][nextb.second] = true;
		}
...
int main() {
	...
	pair<int, string> ans = bfs(hole, red, blue, board);
